...
def cluster_surface(frame:pd.DataFrame)-> pd.DataFrame:
    ...
    for i in range(int(maxC)):
        ...
        cl['id'] = ids
        naps.surface.iloc[ids] = cl.surface
...
def slice_clusters(fname:str='states.npz',
    ...
    particle with respect to the clusters.
...
if __name__ == '__main__':
    type_slices = slice_clusters(fname='states.npz',ignore=1001,
                                    part='sp_state.npy')
